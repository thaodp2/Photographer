...
public class HomeController extends HttpServlet {
    ...
    /**
     * This class contains a method that calls GalleryDAOImpl,
     * ContactDAOImpl,ShareDAOImpl to get top 3 Gallery, list paging Gallery,
     * Contact, a total of the gallery; get parameter index page from the HTTP
     * request and find maxPage then forward to the "Homepage.jsp". Each page
     * will have a maximum of 3 Gallery. Servlet will directly respond to
     * "Error.jsp" when any error occurs
     *
     * @param request stores attributes: top3Gallery, listPagingGallery,
     * gallery, maxPage, index, contact, error to send to JSP. It is a <code> javax.servlet.http.HttpServletRequest
     * </code>
     * @param response sending a response to client's web browser. It is a <code> javax.servlet.http.HttpServletResponse
     * </code>
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Gallery> listTop3Gallery = galleryDAO.getTopGalley(3);
            ...
            int totalGallery = galleryDAO.count();
            if (totalGallery <= 0) {
            ...
            List<Gallery> listGalleryWithPage = galleryDAO.getListGaleryWithPaging(index, pageSize);
